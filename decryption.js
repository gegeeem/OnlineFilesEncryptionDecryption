    ...
    readerForEncryptedFile.onload =  ()=>{
        ...
        readerDataForDec.onload = async ()=>{
            ...
            if (navigator.maxTouchPoints > 1 && navigator.userAgent.includes("Safari")){ 
                ...
                createFileForDownload("#downloadDecFile","data:"+fileType+";base64,"+_arrayBufferToBase64(ciphertext),getUploadedFile.files[0].name.slice(0, getUploadedFile.files[0].name.length - 4)+""+fileType.slice(fileType.search("/") + 1));
