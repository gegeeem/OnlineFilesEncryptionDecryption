        ...
        reader2.onload =async()=>{
            ...
            await window.crypto.subtle.encrypt(
                ...
                reader.result
                    ...
                    createFileForDownload("#dowloadEncFile","data:text/plain;base64,"+_arrayBufferToBase64(res),getFileUploaded.files[0].name);// generisei enkriptovani fajl za preuzimanje
                    // generisanje podataka za dekripciju
                    const newSalt = window.crypto.getRandomValues(new Uint8Array(16));
                    const newWrappingKey = await getKey(userPass,newSalt);
                    await window.crypto.subtle.wrapKey(// wrapuj postojeci glavni kljuc sa kljucem generisanim istom sifrom
                        "raw",
                    ...
                    createFileForDownload("#dataFromEncryption","data:application/json;utf8,"+JSON.stringify(DataForDec),"podaci za dekripciju");
